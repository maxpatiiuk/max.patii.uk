...
export const openApi: Project = {
  ...
  content: (
    <>
      <Aside>
        <Paragraph>This project was presented at TDWG 2021.</Paragraph>
        <List>
          <li>
            <Link href="https://www.youtube.com/watch?list=TLGGVe_xKrhFdrIyMzAyMjAyNQ&v=G_3lzy_wOHI">
              Presentation
            </Link>
          </li>
          <li>
            <Link href="https://biss.pensoft.net/article/75386/">
              Published Abstract
            </Link>
          </li>
        </List>
