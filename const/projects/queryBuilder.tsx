  ...
  localized: {
    'en-US': {
      ...
      content: (
        <>
          <Paragraph>
            Query Builder is an interface for creating advanced queries against
            the database. It is part of the collection management software,
            Specify 7.
          </Paragraph>
          <List
            caption={`
          ...
          >
            ...
            <li>
              Integrates with the permission system. Hides data from tables you
          ...
          <Paragraph>
            The query builder also supports spatial search. You have an ability
            to constrain search to a region you drawn on the map or plot query
          ...
          <Paragraph>
            ...
            in the Specify 7.7 release and describes Query Builder enhancements.
          </Paragraph>
