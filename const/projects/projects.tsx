    ...
    localized: {
      'en-US': {
        ...
        content: (
          <>
            <Paragraph>
              Alia is a programming language I created. It's syntax resembles C.
              It has a compiler for x64 and MIPS assembly. Additionally, it can
              be compiled down to LLVM bitcode, which in turn can be compiled
              for any architecture.
            </Paragraph>
            <Paragraph>
              In addition, Alia includes an interpreter and a hefty test
              coverage.
            </Paragraph>
            <Paragraph>
              For of the documentation of implementation and language
              specification, see{' '}
              <Link href="https://github.com/maxxxxxdlp/alia">
                Alia repository
              </Link>
            </Paragraph>
