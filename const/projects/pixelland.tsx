...
export const pixelland: Project = {
  ...
  content: (
    <>
      ...
      <Paragraph>
        <Link href="https://maxxxxxdlp.github.io/eecs-448-pixelland/eecs-448-project-3/">
      ...
      <Paragraph>
        There is{' '}
        <Link href="https://maxxxxxdlp.github.io/eecs-448-pixelland/documentation/auto-docs-gen/">
