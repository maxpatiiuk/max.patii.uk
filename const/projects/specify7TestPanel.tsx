      ...
      content: (
        <>
          ...
          <Paragraph>
            ...
            repository, for which all automated tests have passed, and which has
            an associated pull request that has been assigned for review to the
            QA team (or a member of the team), and has not yet been reviewed. If
            a pull request has been assigned for review both to a member of the
            development team and a member of the QA team, the test panel deploys
            the branch only after the developer has approved the pull request,
            so as not to waste the QA team's time testing code that may be
            rejected.
          </Paragraph>
          <Paragraph>
            If a maximum number of deployments has already been reached (defined
            in the config file), the test panel tries to destroy old deployments
          ...
          <Paragraph>
            ...
            Dockerized. Docker composition comes with a MariaDB server to
          ...
          <Paragraph>
            ...
            an ability to upload a new database, download an existing one, or
            drop it.
          </Paragraph>
