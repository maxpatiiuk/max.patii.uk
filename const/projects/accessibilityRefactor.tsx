      ...
      content: (
        <>
          ...
          <Paragraph>
            ...
            navigation support, increasing the size of clickable elements,
            adding extra whitespace, increasing contrast, and adding
          ...
          <Paragraph>
            ...
            regular users. For example, I am a big fan of using screen readers,
            not because I have to, but because I like to. I am often too lazy to
            read a long article, so I just let the screen reader do that for me.
          </Paragraph>
          <Paragraph>
            For this and many other reasons, I put accessibility compliance as
            one of the top priorities when planning the next release of Specify
            7 (a scientific collection management software).
          </Paragraph>
          <List
            caption={`
          ...
          >
            ...
            <li>
              ...
              controls wherever possible. If no satisfactory native control
              exists (for example, autocomplete), a custom one was designed and
              tested for compliance with accessibility standards
            </li>
            <li>
            ...
            <li>
              Added dark mode. Interface switches to dark mode automatically if
              set so in system preferences
            </li>
          </List>
          ...
          <Paragraph>
            One of the most challenging parts of the accessibility refactor was
            the tree viewer. The tree viewer should look like a table to a
          ...
          <List caption="These issues were solved in the following ways">
            <li>
              ...
              with "role" of "tree", "treeitem", and "group". This helps
              accessible technology recognize the layout as a tree and announce
              it properly. At the same time, these elements are styled as a
              grid, to mimic a table layout. This ensures all cells in the same
            ...
            <li>
              ...
              expand/contract icons which were given corresponding "aria-label"
              attributes
            </li>
            <li>
          ...
          <Paragraph>
            ...
            of a zoom show-and-tell session is available. It covers new features
            in the Specify 7.7 release and describes accessibility enhancements.
          </Paragraph>
          ...
          <Paragraph>
            A statement of Specify's commitment to accessibility and details on
            the progress made is available as a{' '}
          ...
          <Paragraph>
            The accessibility statement describes that 100% WCAG 2.1 compliance
            is not going to be achievable because of inaccessible third-party
