  ...
  localized: {
    'en-US': {
      ...
      content: (
        <>
          <Paragraph>
            A simple turn-based game of war. Place up to 6 ships on a 9x10 grid
            and try to sink your opponent's ships before they sink yours.
          </Paragraph>
          <Paragraph>
            I worked on this project in a Team of 5. I took on the
            responsibilities of a team lead, which involved keeping the team on
            track, prioritizing features, and working on the most complex parts
            of the project.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            Kansas. One of the goals of the project was to write readable code
            with sufficient documentation for another team of 5 students to be
            able to pick up our game and add additional features.
          </Paragraph>
          <Paragraph>
            ...
            players, we chose a simpler, and ultimately more intimate approach.
            Two players are supposed to open the game on separate computers.
            When any player makes a move, they are supposed to ask the opposite
            if it was a hit or miss and press the corresponding button in the
            game when promoted.
          </Paragraph>
          <Paragraph>
