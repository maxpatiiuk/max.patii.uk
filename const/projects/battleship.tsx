...
export const battleship: Project = {
  ...
  content: (
    <>
      ...
      <Paragraph>
        <Link href="https://maxxxxxdlp.github.io/eecs-448-battleship/eecs-448-battleship/">
      ...
      <Paragraph>
        There is{' '}
        <Link href="https://maxxxxxdlp.github.io/eecs-448-battleship/documentation/auto-docs-gen/">
